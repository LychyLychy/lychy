...
//-----------------------------------------------------------------------------
class CHL1HudWeaponSelection : public CBaseHudWeaponSelection, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHL1HudWeaponSelection, vgui::Panel );

public:
	CHL1HudWeaponSelection(const char *pElementName );
...
DECLARE_HUDELEMENT( CHL1HudWeaponSelection );
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHL1HudWeaponSelection::CHL1HudWeaponSelection( const char *pElementName ) : CBaseHudWeaponSelection(pElementName), BaseClass(NULL, "HL1HudWeaponSelection")
{
...
void CHL1HudWeaponSelection::VidInit()
{
	Reset();
...
//-----------------------------------------------------------------------------
bool CHL1HudWeaponSelection::ShouldDraw()
{
...
//-------------------------------------------------------------------------
void CHL1HudWeaponSelection::Paint()
{
	if (!ShouldDraw())
		return;
...
void CHL1HudWeaponSelection::DrawAmmoBar( C_BaseCombatWeapon *pWeapon, int x, int y, int nWidth, int nHeight )
{
...
int CHL1HudWeaponSelection::DrawBar( int x, int y, int nWidth, int nHeight, float flPct )
{
	Color clrBar;
	int r, g, b, a;
...
//-----------------------------------------------------------------------------
void CHL1HudWeaponSelection::ApplySchemeSettings(vgui::IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CHL1HudWeaponSelection::FindNextWeaponInWeaponSelection(int iCurrentSlot, int iCurrentPosition)
{
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
		return NULL;
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CHL1HudWeaponSelection::FindPrevWeaponInWeaponSelection(int iCurrentSlot, int iCurrentPosition)
{
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
		return NULL;
...
//-----------------------------------------------------------------------------
void CHL1HudWeaponSelection::CycleToNextWeapon( void )
{
...
//-----------------------------------------------------------------------------
void CHL1HudWeaponSelection::CycleToPrevWeapon( void )
{
	// Get the local player.
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CHL1HudWeaponSelection::GetWeaponInSlot( int iSlot, int iSlotPos )
{
...
//-----------------------------------------------------------------------------
void CHL1HudWeaponSelection::SelectWeaponSlot( int iSlot )
{
...
//-----------------------------------------------------------------------------
void CHL1HudWeaponSelection::FastWeaponSwitch( int iWeaponSlot )
{
...
C_BaseCombatWeapon *CHL1HudWeaponSelection::GetNextActivePos( int iSlot, int iSlotPos )
{
	if ( iSlot >= HL1_MAX_WEAPON_SLOTS )
		return NULL;
