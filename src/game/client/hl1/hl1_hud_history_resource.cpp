...
#include "hl1_hud_history_resource.h"
...
DECLARE_HUDELEMENT( CHL1HudHistoryResource );
DECLARE_HUD_MESSAGE( CHL1HudHistoryResource, ItemPickup );

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
CHL1HudHistoryResource::CHL1HudHistoryResource( const char *pElementName ) :
	BaseClass(pElementName)
{	
	SetName("HL1HudHistoryResource");
...
// Input  : *pScheme - 
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::ApplySchemeSettings( IScheme *pScheme )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::Init( void )
{
	HOOK_HUD_MESSAGE( CHL1HudHistoryResource, ItemPickup );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::Reset( void )
{
...
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::SetHistoryGap( int iNewHistoryGap )
{
...
void CHL1HudHistoryResource::AddToHistory( C_BaseCombatWeapon *weapon )
{
...
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::AddToHistory( int iType, int iId, int iCount )
{
...
// Purpose: Add a new entry to the pickup history
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::AddToHistory( int iType, const char *szName, int iCount )
{
...
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::MsgFunc_ItemPickup(bf_read &msg)
{
	char szString[2048];
...
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::CheckClearHistory( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CHL1HudHistoryResource::ShouldDraw( void )
{
...
//-----------------------------------------------------------------------------
void CHL1HudHistoryResource::Paint( void )
{
	for ( int i = 0; i < m_PickupHistory.Count(); i++ )
	{
		if ( m_PickupHistory[i].type )
