...
//-----------------------------------------------------------------------------
class CHL1HudDamageIndicator : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHL1HudDamageIndicator, vgui::Panel );

public:
	CHL1HudDamageIndicator( const char *pElementName );
...
DECLARE_HUDELEMENT( CHL1HudDamageIndicator );
DECLARE_HUD_MESSAGE( CHL1HudDamageIndicator, Damage );

//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHL1HudDamageIndicator::CHL1HudDamageIndicator( const char *pElementName ) : CHudElement( pElementName ), BaseClass(NULL, "HL1HudDamageIndicator")
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHL1HudDamageIndicator::Reset( void )
{
	m_flAttackFront	= 0.0;
	m_flAttackRear	= 0.0;
	m_flAttackRight	= 0.0;
...
void CHL1HudDamageIndicator::Init( void )
{
	HOOK_HUD_MESSAGE( CHL1HudDamageIndicator, Damage );
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
bool CHL1HudDamageIndicator::ShouldDraw( void )
{
...
void CHL1HudDamageIndicator::DrawDamageIndicatorFront( float flFade )
{
...
void CHL1HudDamageIndicator::DrawDamageIndicatorRear( float flFade )
{
...
void CHL1HudDamageIndicator::DrawDamageIndicatorLeft( float flFade )
{
...
void CHL1HudDamageIndicator::DrawDamageIndicatorRight( float flFade )
{
...
//-----------------------------------------------------------------------------
void CHL1HudDamageIndicator::Paint()
{
...
//-----------------------------------------------------------------------------
void CHL1HudDamageIndicator::MsgFunc_Damage( bf_read &msg )
{
...
void CHL1HudDamageIndicator::CalcDamageDirection( const Vector &vecFrom )
{
...
//-----------------------------------------------------------------------------
void CHL1HudDamageIndicator::ApplySchemeSettings(vgui::IScheme *pScheme)
{
