...
//-----------------------------------------------------------------------------
class CHL1HudDamageTiles : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHL1HudDamageTiles, vgui::Panel );

public:
	CHL1HudDamageTiles( const char *pElementName );
...
DECLARE_HUDELEMENT( CHL1HudDamageTiles );
DECLARE_HUD_MESSAGE( CHL1HudDamageTiles, Damage );


//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHL1HudDamageTiles::CHL1HudDamageTiles( const char *pElementName ) : CHudElement( pElementName ), BaseClass(NULL, "HL1HudDamageTiles")
{
...
void CHL1HudDamageTiles::Init( void )
{
	HOOK_HUD_MESSAGE( CHL1HudDamageTiles, Damage );
}


void CHL1HudDamageTiles::VidInit( void )
{
	Reset();
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHL1HudDamageTiles::Reset( void )
{
	m_bitsDamage = 0;
...
CHudTexture *CHL1HudDamageTiles::DamageTileIcon( int i )
{
	switch ( i )
	{
	case 0:
...
long CHL1HudDamageTiles::DamageTileFlags( int i )
{
	switch ( i )
	{
	case 0:
...
//-----------------------------------------------------------------------------
void CHL1HudDamageTiles::MsgFunc_Damage( bf_read &msg )
{
						msg.ReadByte();	// armor
						msg.ReadByte();	// health
...
bool CHL1HudDamageTiles::ShouldDraw( void )
{
...
void CHL1HudDamageTiles::Paint( void )
{
	int				r, g, b, a, nUnused;
...
void CHL1HudDamageTiles::UpdateTiles( long bitsDamage )
{	
	damagetile_t *pDmgTile;
...
void CHL1HudDamageTiles::ApplySchemeSettings(vgui::IScheme *pScheme)
{
